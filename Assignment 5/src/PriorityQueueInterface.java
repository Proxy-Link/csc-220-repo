...
public interface PriorityQueueInterface<T extends Comparable<? super T>> {
   ...
   * Add should maintain the entries in sorted order by their priorities.
   * That is, the highest priority item should occur at the end of the array,
   * so removing it would leave the other entries in their present places.
